                  ...
                  children: [
                    ElevatedButton(
                      onPressed: () async {
                        ...
                        final welcomeMessage = await group.addMemberToGroup(
                          bytes,
                        );

                        print(welcomeMessage);

                        Clipboard.setData(ClipboardData(text: welcomeMessage));
                    ...
                    return ListView(
                      children: [
                        for (final member in group.members)
                          ListTile(title: Text(utf8.decode(member.identity))),
                      ],
                    );
                  },
                ),
