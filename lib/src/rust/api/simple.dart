...
Future<OpenMlsConfig> openmlsInitConfig({required List<int> keystoreDump}) =>
    RustLib.instance.api.crateApiSimpleOpenmlsInitConfig(
      keystoreDump: keystoreDump,
    );
...
}) => RustLib.instance.api.crateApiSimpleOpenmlsSignerGetPublicKey(
  signer: signer,
);
...
Future<MlsGroup> openmlsGroupJoin({
  ...
  required OpenMlsConfig config,
}) => RustLib.instance.api.crateApiSimpleOpenmlsGroupJoin(
  welcomeIn: welcomeIn,
  config: config,
);
...
Future<Uint8List> openmlsGroupSave({
  required MlsGroup group,
  required OpenMlsConfig config,
}) => RustLib.instance.api.crateApiSimpleOpenmlsGroupSave(
  group: group,
  config: config,
);
